...
async function loadStats() {
  try {
    ...
    statsGrid.innerHTML =
      ...
      '<div class="stat-card atendida"><div><div class="number" data-count-to="' + (stats.atendidas || 0) + '">' + (stats.atendidas || 0) + '</div><div class="label">Atendidas</div></div><div class="stat-card__icon"><i class="fa-solid fa-wrench"></i></div></div>' +
